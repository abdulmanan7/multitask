...
Für Ihre Zuarbeit bedanken wir uns mit einem <strong>150 € Extra Rabatt auf Ihre neue SOLARvent Pelletheizung.</strong><br>
			...
			<div class="form-group">
				<div class="row">
					...
					<div class="col-sm-6">
						<div class="row">
							<div class="col-xs-6">
								<input required="required" name="question4" type="text" class="form-control numberOnly"></input>
								<p class="error"></p>
							</div>
							<div class="col-xs-6">
			...
			<div class="form-group">
				<div class="row">
					...
					<div class="col-sm-6">
						<input name="question5" type="text" class="form-control numberOnly"></input>
						<p class="error"></p>
					</div>
				</div>
			</div>
